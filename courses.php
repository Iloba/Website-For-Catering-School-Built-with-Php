...
<head>
    ...
    <title>Dee Bakers~~ Courses</title>
</head>
<body>
    ...
    <div class="container-fluid">
        <div class="row header">
            ...
            <div class="col-md-10 col-sm-4 col-xs-12">
                <div class="name"><h1 class="text-center dal">Dee Bakers Catering Services <br><h2 class="text-center under"> and Training Centre</h2></h1></div>
            </div>          
        </div>
    </div><br>
    <div class="container-fluid">
        <div class="row second"><br>
            <div class="col-md-6 one text-center">
                <div><img class="phone" src="img/welcome2.png" alt="Welcome"> Welcome to Dee Bakers Stores We are Here For you</div>
            </div>
    ...
    <nav class=" sticky-top navbar navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand" id="brand" href="index.php">Dee Bakers Catering Services</a>
    ...
    <div class="sectionTwo">
        <div class="jumbotron jumbotron-fluid">
            <div class="container">
                <div class="col-md-12">
                <h1 class="wel">Register For a Course</h1>
                   <div>
                       <form method="POST" action="">
                            <input type="text" class="form-control" name="fname" placeholder="Enter Full Name" required><br>
                            <select class="form-control" name="sex" name="sex" required>
                                <option value="">---Select---</option>
                                <option value="Male">Male</option>
                                <option value="Male">Female</option>
                            </select><br>
                            <input type="text" class="form-control" name="age" placeholder="Enter Age" required><br>
                            <input type="text" class="form-control" name="phone" placeholder="Enter Phone Number" required><br>
                            <input type="text" class="form-control" name="addr" placeholder="Enter Address" required><br>
